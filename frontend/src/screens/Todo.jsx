 ...
 const [toggleCheckBox, setToggleCheckBox] = useState(false)
  return (
    <View style={styles.container}>
      ...
      >
        <View  style={{height:"45%",marginTop:"30%" , marginLeft:20,marginRight:20 , backgroundColor:"#FF3030",alignItems:"center",justifyContent:"center",}}>
        <TextInput
        style={styles.input}
      ...
      />
  <TouchableOpacity onPress={()=>{addData(task);setModalVisible(false)}}  style={{backgroundColor:"#FF3030",padding:15,alignItems:"center"
...
<TouchableOpacity onPress={()=>{setModalVisible(true)}}  style={{backgroundColor:"#FF3030",padding:15,alignItems:"center"
     ,marginTop:20 ,borderRadius:4,width:"60%"}}>
